...
export default function Home() {
  return (
    <main style={{ minHeight: '100vh', backgroundColor: '#000', color: '#fff', fontFamily: '-apple-system, BlinkMacSystemFont, "San Francisco", "Helvetica Neue", sans-serif', position: 'relative', overflowX: 'hidden' }}>
      ...
      {/* Notice: height: 100vh is REMOVED so the container expands and lets you scroll normally! */}
      ...
      {/* REELS SECTION */}
      {/* Notice: blurAmount={0} ensures your videos play without glitching! */}
      <section id="projects" style={{ width: '100vw', backgroundColor: '#000', position: 'relative', zIndex: 20 }}>
